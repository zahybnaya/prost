...
void DPUCTSearch::initializeDecisionNodeChild(DPUCTNode* node,
   ...
   // cout<<"DP initializeDecisionNode node->futureReward:"<<node->futureReward<< " node->expected"<<node->getExpectedRewardEstimate()<<endl;
...
void DPUCTSearch::backupDecisionNodeLeaf(DPUCTNode* node,
    ...
    ++node->numberOfVisits;
    //cout<<"DP:	leaf. node->expectedReward" << node->getExpectedRewardEstimate()<<endl;
...
void DPUCTSearch::backupDecisionNode(DPUCTNode* node,
    ...
    //cout<<"DP: backupDecisionNode expectedreward:"<<node->getExpectedRewardEstimate()<<endl;
...
void DPUCTSearch::backupChanceNode(DPUCTNode* node,
    ...
    //cout<<"DP: backupChanceNode expectedreward:"<<node->getExpectedRewardEstimate()<<endl;
